...
const ENCRYPTION_KEY = '3fb2899c1361759805f8a6a2244b396eeea26e2c70931d58241fbe3d40f44e94'
const SUPABASE_URL = 'https://dmtctlpzlfpcogpjweuv.supabase.co'
const SERVICE_ROLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRtdGN0bHB6bGZwY29ncGp3ZXV2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3ODEyNjE2NywiZXhwIjoyMDkzNzAyMTY3fQ.WsnfS6CmBmo_ad71fM3djHNyzKdJKEV6WSy2S-5_FcY'
...
const credentials = [
  // ── Global AI / Dev Keys ──────────────────────────────────────────────────
  {
    ...
    value: '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',
    tier: 'global',
    project_id: null,
    is_mcp_accessible: true,
    notes: 'Primary Anthropic API key — used by all projects',
  },
  {
    name: 'OpenAI API Key',
